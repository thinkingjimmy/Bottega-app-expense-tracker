...
export function Button(props: React.ComponentProps<typeof ButtonPrimitive>) {
  return (
    <ButtonPrimitive
      {...props}
      className={classes(
        `inline-flex min-h-11 items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 font-medium text-white hover:bg-blue-700 active:bg-blue-800 ${focus} disabled:cursor-not-allowed disabled:opacity-50`,
        props.className,
      )}
    />
  );
...
export function Input(props: React.ComponentProps<typeof InputPrimitive>) {
  return (
    <InputPrimitive
      {...props}
      className={classes(`w-full ${control}`, props.className)}
    />
  );
}
...
export function Textarea(props: React.ComponentProps<"textarea">) {
  return (
    <textarea
      {...props}
      className={cn(`w-full resize-y py-2 ${control}`, props.className)}
    />
  );
}
...
export function Checkbox(
  ...
  return (
    <CheckboxPrimitive.Root
      {...props}
      className={classes(
        `inline-flex size-11 items-center justify-center rounded-lg border border-slate-300 bg-white ${focus} data-[checked]:border-blue-600 data-[checked]:bg-blue-600 dark:border-slate-700 dark:bg-slate-950`,
        props.className,
      )}
    >
      <CheckboxPrimitive.Indicator className="text-lg font-bold text-white">
        ✓
...
export function Switch(
  ...
  return (
    <SwitchPrimitive.Root
      {...props}
      className={classes(
        `inline-flex h-11 w-14 items-center rounded-full bg-slate-300 p-1 ${focus} data-[checked]:bg-blue-600 dark:bg-slate-700`,
        props.className,
      )}
    >
...
export function RadioGroup(
  props: React.ComponentProps<typeof RadioGroupPrimitive>,
) {
  return (
    <RadioGroupPrimitive
      {...props}
      className={classes("grid gap-2", props.className)}
    />
  );
}
...
export function Radio(props: React.ComponentProps<typeof RadioPrimitive.Root>) {
  return (
    <RadioPrimitive.Root
      {...props}
      className={classes(
        `inline-flex size-11 items-center justify-center rounded-full ${focus}`,
        props.className,
      )}
    >
